...
- [ ] GitHub W00–W17 milestones are configured.
- [ ] GitHub Project Board workflow is configured.
- [ ] GitHub issue/PR governance templates are configured as required.
- [ ] Initial Git baseline is committed and pushed.
- [ ] Repository default branch and governance state are verified.
...
- consistency and content-quality audit
- preservation of sufficient detailed Phase 01–13 planning decisions
- initial Git commit/push
- GitHub execution governance
- repository governance/templates
- applicable validation/CI
